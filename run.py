...
from data import CaviarDataset, CaviarFrames
...
model = Model("Problog/addition.pl", [net])
model.set_engine(ExactEngine(model))
model.add_tensor_source("train", CaviarFrames("train")) 
model.add_tensor_source("test", CaviarFrames("test")) 

dataset = CaviarDataset("train")
